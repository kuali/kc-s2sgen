									...
									<fo:table-row>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
														<xsl:when
																test="RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedTravel/RR_FedNonFedBudget_1_2:FederalSummary = '' or not(RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedTravel/RR_FedNonFedBudget_1_2:FederalSummary)">
														<fo:inline>&#160;</fo:inline>
													</xsl:when>
													<xsl:otherwise>
															<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedTravel/RR_FedNonFedBudget_1_2:FederalSummary, '#,##0.00')"
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
														<xsl:when
																test="RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedTravel/RR_FedNonFedBudget_1_2:NonFederalSummary = '' or not(RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedTravel/RR_FedNonFedBudget_1_2:NonFederalSummary)">
														<fo:inline>&#160;</fo:inline>
													</xsl:when>
													<xsl:otherwise>
															<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedTravel/RR_FedNonFedBudget_1_2:NonFederalSummary, '#,##0.00')"
																		  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
														<xsl:when
																test="RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedTravel/RR_FedNonFedBudget_1_2:TotalFedNonFedSummary = '' or not(RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedTravel/RR_FedNonFedBudget_1_2:TotalFedNonFedSummary)">
														<fo:inline>&#160;</fo:inline>
													</xsl:when>
													<xsl:otherwise>
															<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedTravel/RR_FedNonFedBudget_1_2:TotalFedNonFedSummary, '#,##0.00')"
																		  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedOtherDirectCosts/RR_FedNonFedBudget_1_2:FederalSummary
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedOtherDirectCosts/RR_FedNonFedBudget_1_2:NonFederalSummary
,'#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeTotalFundsRequestedOtherDirectCosts/RR_FedNonFedBudget_1_2:TotalFedNonFedSummary
,'#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeMaterialAndSupplies/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeMaterialAndSupplies/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeMaterialAndSupplies/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativePublicationCosts/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativePublicationCosts/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativePublicationCosts/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeConsultantServices/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeConsultantServices/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeConsultantServices/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeADPComputerServices/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeADPComputerServices/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeADPComputerServices/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeSubawardConsortiumContractualCosts/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeSubawardConsortiumContractualCosts/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeSubawardConsortiumContractualCosts/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeEquipmentFacilityRentalFees/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeEquipmentFacilityRentalFees/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeEquipmentFacilityRentalFees/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeAlterationsAndRenovations/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeAlterationsAndRenovations/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeAlterationsAndRenovations/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeOther1DirectCost/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeOther1DirectCost/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeOther1DirectCost/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeOther2DirectCost/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeOther2DirectCost/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeOther2DirectCost/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeOther3DirectCost/RR_FedNonFedBudget_1_2:Federal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeOther3DirectCost/RR_FedNonFedBudget_1_2:NonFederal
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
										...
										<fo:table-cell text-align="right">
											<fo:block>
												<xsl:choose>
													...
													<xsl:otherwise>
														<xsl:value-of select="format-number(RR_FedNonFedBudget_1_2:CumulativeOther3DirectCost/RR_FedNonFedBudget_1_2:TotalFedNonFed
, '#,##0.00')" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"/>
													</xsl:otherwise>
												</xsl:choose>
											</fo:block>
