...
<!--
 ...
 -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:PHS398_CareerDevelopmentAwardSup_2_0="http://apply.grants.gov/forms/PHS398_CareerDevelopmentAwardSup_2_0-V2.0" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:codes="http://apply.grants.gov/system/UniversalCodes-V2.0" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
									...
									<!--fo:table-row>
										<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
											<fo:block>
												...
												<fo:block/>
												<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
													<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:ApplicationType">
														<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:TypeOfApplication">
															<xsl:choose>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:IntroductionToApplication">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
													...
													<fo:table-body start-indent="0pt">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CandidateBackground">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerGoalsAndObjectives">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>4. Candidate's Plan for Career Development/</xsl:text>
																	</fo:inline>
																	<fo:block/>
																	<fo:inline>
																		<xsl:text>   Training Activities During Award Period</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAndTrainingActivities">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:ResponsibleConductOfResearch">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:MentoringPlan">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
													...
													<fo:table-body start-indent="0pt">
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>7. Plans and Statements of Mentor and Co-</xsl:text>
																	</fo:inline>
																	<fo:block/>
																	<fo:inline>
																		<xsl:text>Mentor(s)</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:StatementsOfSupport">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:LettersOfSupport">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:InsitutionalEnvironment">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:InstitutionalCommitment">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:SpecificAims">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:ResearchStrategy">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:InclusionEnrollmentReport">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:ProgressReportPublicationList">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:ProtectionOfHumanSubjects">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:InclusionOfWomenAndMinorities">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:TargetedPlannedEnrollment">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:InclusionOfChildren">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:VertebrateAnimals">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:SelectAgentResearch">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:ConsortiumContractualArrangements">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:ResourceSharingPlans">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	...
																	<xsl:if test="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0/PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments/PHS398_CareerDevelopmentAwardSup_2_0:Appendix/att:AttachedFile">
																		<fo:table font-family="v" font-size="9pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			<fo:table-column column-width="proportional-column-width(1)"/>
																			<fo:table-body start-indent="0pt">
																				<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																					<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:CareerDevelopmentAwardAttachments">
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:Appendix">
														...
														<fo:table-row font-size="8pt">
															<fo:table-cell number-columns-spanned="4" padding="2pt" display-align="before">
																<fo:block>
																	...
																	<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:PHS398_CareerDevelopmentAwardSup_2_0">
																		<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_2_0:Citizenship">
																			<xsl:choose>
