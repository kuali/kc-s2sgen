...
<!--
 ...
 -->
<!-- $Revision:   1.4  $ -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:footer="http://apply.grants.gov/system/Footer-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:RR_SubawardBudget10_30_1_4="http://apply.grants.gov/forms/RR_SubawardBudget10_30_1_4-V1.4" xmlns:RR_Budget10_1_4="http://apply.grants.gov/forms/RR_Budget10_1_4-V1.4" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
								...
								<fo:table-body>
									...
									<xsl:for-each select="RR_Budget10_1_4:BudgetSummary">
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeEquipments/RR_Budget10_1_4:CumulativeTotalFundsRequestedEquipment">
														<fo:inline font-weight="bold">
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeTravels/RR_Budget10_1_4:CumulativeTotalFundsRequestedTravel">
														<fo:inline font-weight="bold">
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeTravels/RR_Budget10_1_4:CumulativeDomesticTravelCosts">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeTravels/RR_Budget10_1_4:CumulativeForeignTravelCosts">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeTrainee/RR_Budget10_1_4:CumulativeTotalFundsRequestedTraineeCosts">
														<fo:inline font-weight="bold">
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeTrainee/RR_Budget10_1_4:CumulativeTraineeTuitionFeesHealthInsurance">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeTrainee/RR_Budget10_1_4:CumulativeTraineeStipends">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeTrainee/RR_Budget10_1_4:CumulativeTraineeTravel">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeTrainee/RR_Budget10_1_4:CumulativeTraineeSubsistence">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeTrainee/RR_Budget10_1_4:CumulativeOtherTraineeCost">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:value-of select="RR_Budget10_1_4:CumulativeTrainee/RR_Budget10_1_4:CumulativeNoofTrainees"/>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell>
												<fo:block/>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeTotalFundsRequestedOtherDirectCosts">
														<fo:inline font-weight="bold">
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeMaterialAndSupplies">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativePublicationCosts">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeConsultantServices">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeADPComputerServices">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeSubawardConsortiumContractualCosts">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeEquipmentFacilityRentalFees">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeAlterationsAndRenovations">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeOther1DirectCost">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeOther2DirectCost">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
										...
										<fo:table-row>
											...
											<fo:table-cell text-align="right">
												<fo:block>
													<xsl:for-each select="RR_Budget10_1_4:CumulativeOtherDirect/RR_Budget10_1_4:CumulativeOther3DirectCost">
														<fo:inline>
															<xsl:value-of select="format-number(., '#,##0.00')"/>
														</fo:inline>
													</xsl:for-each>
	...
	<xsl:template name="SingleYearPart1">
		...
		<fo:block page-break-before="always">
			...
			<fo:block font-size="8pt">
				...
				<fo:inline>
					<xsl:value-of select="../RR_Budget10_1_4:DUNSID"/>
				</fo:inline>
			</fo:block>
						...
						<fo:table-cell hyphenate="true" language="en" border-style="solid" border-color="black" padding-start="1pt" padding-end="1pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="start">
							<fo:block>
								...
								<fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt" table-layout="fixed">
									...
									<fo:table-body>
										<xsl:if test="string-length(RR_Budget10_1_4:Equipment)=0">
											<fo:table-row>
												<fo:table-cell >
													<fo:block/>
												</fo:table-cell>
										...
										<xsl:for-each select="RR_Budget10_1_4:Equipment">
											...
											<xsl:if test="string-length(RR_Budget10_1_4:EquipmentList)=0">
												<fo:table-row>
													<fo:table-cell >
														<fo:block/>
													</fo:table-cell>
			...
			<fo:table border-style="solid" border-color="black" width="100%" space-before.optimum="1pt" space-after.optimum="2pt" table-layout="fixed">
				...
				<fo:table-body>
					...
					<xsl:for-each select="RR_Budget10_1_4:OtherDirectCosts">
						...
						<xsl:for-each select="RR_Budget10_1_4:Others">
							<xsl:for-each select="RR_Budget10_1_4:Other">
								<fo:table-row>
									<fo:table-cell hyphenate="true" language="en" line-height="9pt" padding-start="1pt" padding-end="1pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="start">
										<fo:block>
				...
				<fo:table-body>
					<fo:table-row>
						...
						<fo:table-cell padding-start="1pt" padding-end="1pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="start">
							<fo:block>
								<fo:inline font-size="8pt">File Name: </fo:inline>
								<xsl:for-each select="../RR_Budget10_1_4:BudgetYear1/RR_Budget10_1_4:BudgetJustificationAttachment/att:FileName">
									<fo:inline font-size="8pt">
										<xsl:apply-templates/>
									</fo:inline>
								</xsl:for-each>
						...
						<fo:table-cell padding-start="1pt" padding-end="1pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="start">
							<fo:block>
								<fo:inline font-size="8pt">Mime Type: </fo:inline>
								<xsl:for-each select="../RR_Budget10_1_4:BudgetYear1/RR_Budget10_1_4:BudgetJustificationAttachment/att:MimeType">
									<fo:inline font-size="8pt">
										<xsl:apply-templates/>
									</fo:inline>
								</xsl:for-each>
