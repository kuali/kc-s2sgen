...
xmlns:PHS398_CoverPageSupplement_1_3="http://apply.grants.gov/forms/PHS398_CoverPageSupplement_1_3-V1.3" 
...
xmlns:header="http://apply.grants.gov/system/Header-V1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
   ...
   <xsl:template match="PHS398_CoverPageSupplement_1_3:PHS398_CoverPageSupplement_1_3">
      <fo:root>
            ...
            <fo:flow flow-name="xsl-region-body">
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="276.969696969697px" top="125.45454545454547px" height="13.333333333333334px" width="284.8484848484849px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:FirstName) or PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:FirstName = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:FirstName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="83.03030303030303px" top="138.78787878787878px" height="13.333333333333334px" width="207.27272727272728px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:MiddleName) or PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:MiddleName = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:MiddleName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="83.03030303030303px" top="152.12121212121212px" height="13.333333333333334px" width="478.7878787878788px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:LastName) or PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:LastName = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:LastName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="277.57575757575756px" top="441.21212121212125px" height="13.333333333333334px" width="284.8484848484849px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:FirstName) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:FirstName = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:FirstName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="83.63636363636364px" top="454.54545454545456px" height="13.333333333333334px" width="207.27272727272728px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:MiddleName) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:MiddleName = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:MiddleName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="83.63636363636364px" top="468.4848484848485px" height="13.333333333333334px" width="478.7878787878788px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:LastName) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:LastName = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:LastName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="353.93939393939394px" top="510.90909090909093px" height="13.333333333333334px" width="207.27272727272728px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactFax) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactFax = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactFax"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="57.57575757575758px" top="525.4545454545455px" height="13.333333333333334px" width="478.7878787878788px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactEmail) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactEmail = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactEmail"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="89.0909090909091px" top="510.90909090909093px" height="13.333333333333334px" width="207.27272727272728px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactPhone) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactPhone = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactPhone"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="57.57575757575758px" top="580px" height="13.333333333333334px" width="367.2727272727273px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactTitle) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactTitle = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactTitle"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="70.30303030303031px" top="612.7272727272727px" height="13.333333333333334px" width="440px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Street1) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Street1 = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Street1"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="70.30303030303031px" top="626.0606060606061px" height="13.333333333333334px" width="440px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Street2) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Street2 = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Street2"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="70.30303030303031px" top="639.3939393939394px" height="13.333333333333334px" width="284.8484848484849px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:City) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:City = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:City"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="70.30303030303031px" top="652.7272727272727px" height="13.333333333333334px" width="246.06060606060606px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:County) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:County = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:County"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="70.30303030303031px" top="680.6060606060606px" height="13.333333333333334px" width="246.06060606060606px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Province) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Province = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Province"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
              <fo:block-container background-color="transparent" border-style="none" position="absolute" left="425px" top="700.6060606060606px" height="13.333333333333334px" width="100px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:ZipPostalCode) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:ZipPostalCode = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:ZipPostalCode"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>               
              ...
              <fo:block-container background-color="transparent" border-style="none" position="absolute" left="350px" top="700.6060606060606px" height="12.121212121212121px" width="125px">
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="146.66666666666669px" top="216.36363636363637px" height="12.121212121212121px" width="18.181818181818183px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="ZapfDingbats" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:isNewInvestigator) or PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:isNewInvestigator = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:call-template name="radioButton">
                              <xsl:with-param name="value" select="PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:isNewInvestigator"/>
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="207.8787878787879px" top="316.3636363636364px" height="12.121212121212121px" width="18.181818181818183px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="ZapfDingbats" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ClinicalTrial/PHS398_CoverPageSupplement_1_3:isClinicalTrial) or PHS398_CoverPageSupplement_1_3:ClinicalTrial/PHS398_CoverPageSupplement_1_3:isClinicalTrial = ''">
                           <xsl:call-template name="radioButton">
                        ...
                        <xsl:otherwise>
                           <xsl:call-template name="radioButton">
                              <xsl:with-param name="value" select="PHS398_CoverPageSupplement_1_3:ClinicalTrial/PHS398_CoverPageSupplement_1_3:isClinicalTrial"/>
                              <xsl:with-param name="schemaChoice">N: No</xsl:with-param>
                           </xsl:call-template>
                        </xsl:otherwise>
                     </xsl:choose>
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="207.8787878787879px" top="343.6363636363637px" height="12.121212121212121px" width="18.181818181818183px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="ZapfDingbats" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ClinicalTrial/PHS398_CoverPageSupplement_1_3:isPhaseIIIClinicalTrial) or PHS398_CoverPageSupplement_1_3:ClinicalTrial/PHS398_CoverPageSupplement_1_3:isPhaseIIIClinicalTrial = ''">
                           <xsl:call-template name="radioButton">
                              <xsl:with-param name="value">N: No</xsl:with-param>
                              <xsl:with-param name="schemaChoice">Y: Yes</xsl:with-param>
                           </xsl:call-template>
                        ...
                        <xsl:otherwise>
                           <xsl:call-template name="radioButton">
                              <xsl:with-param name="value" select="PHS398_CoverPageSupplement_1_3:ClinicalTrial/PHS398_CoverPageSupplement_1_3:isPhaseIIIClinicalTrial"/>
                              <xsl:with-param name="schemaChoice">N: No</xsl:with-param>
                           </xsl:call-template>
                        </xsl:otherwise>
                     </xsl:choose>
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="83.03030303030303px" top="125.45454545454547px" height="13.333333333333334px" width="81.21212121212122px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:PrefixName) or PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:PrefixName = ''">
                           <fo:inline color="#FFFFFF">&#160; </fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:PrefixName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="83.03030303030303px" top="166.06060606060606px" height="13.333333333333334px" width="81.21212121212122px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:SuffixName) or PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:SuffixName = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:PDPI/PHS398_CoverPageSupplement_1_3:PDPIName/globLib:SuffixName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="83.63636363636364px" top="441.21212121212125px" height="13.333333333333334px" width="81.21212121212122px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:PrefixName) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:PrefixName = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:PrefixName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="83.63636363636364px" top="481.21212121212125px" height="13.333333333333334px" width="81.21212121212122px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:SuffixName) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:SuffixName = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactName/globLib:SuffixName"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="70.30303030303031px" top="666.6666666666667px" height="13.333333333333334px" width="246.06060606060606px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:State) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:State = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:State"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="70.30303030303031px" top="700.0000000000000px" height="13.333333333333334px" width="250px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Country) or PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Country = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:ContactPersonInfo/PHS398_CoverPageSupplement_1_3:ContactAddress/globLib:Country"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
  ...
  <fo:block background-color="transparent" color="#000000" text-align="center" font-size="14pt" font-style="normal" font-family="Helvetica" font-weight="bold">PHS 398 Cover Page Supplement</fo:block> 
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="211px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[1]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[1] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[1]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="226px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[2]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[2] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[2]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="241px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[3]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[3] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[3]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="256.5px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[4]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[4] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[4]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="272px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[5]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[5] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[5]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="287px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[6]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[6] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[6]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="302px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[7]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[7] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[7]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="317px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[8]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[8] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[8]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="332px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[9]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[9] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[9]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="347px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[10]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[10] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[10]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="362px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[11]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[11] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[11]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="377px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[12]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[12] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[12]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="392px" height="12.121212121212121px" width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[13]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[13] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[13]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="407px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[14]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[14] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[14]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="422px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[15]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[15] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[15]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="437px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[16]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[16] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[16]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="452px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[17]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[17] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[17]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="467px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[18]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[18] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[18]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="482px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[19]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[19] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[19]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="45.45454545454546px" top="497px" height="12.121212121212121px"  width="60.60606060606061px" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[20]) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[20] = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:CellLines[20]"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
...
registry will be used:</fo:block>
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="333.33333333333337px" top="105.45454545454545px" height="12.121212121212121px" width="18.181818181818183px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="ZapfDingbats" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:isHumanStemCellsInvolved) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:isHumanStemCellsInvolved = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:call-template name="radioButton">
                              <xsl:with-param name="value" select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:isHumanStemCellsInvolved"/>
                              <xsl:with-param name="schemaChoice">N: No</xsl:with-param>
                           </xsl:call-template>
                        </xsl:otherwise>
                     </xsl:choose>
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="123.63636363636364px" top="192px" height="12.121212121212121px" width="18.181818181818183px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="ZapfDingbats" font-weight="normal">
                     <xsl:choose>
                        <xsl:when test="not(PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:StemCellsIndicator) or PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:StemCellsIndicator = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                     ...
                     <xsl:choose>
                        ...
                        <xsl:otherwise>
                           <xsl:call-template name="checkbox">
                              <xsl:with-param name="value" select="PHS398_CoverPageSupplement_1_3:StemCells/PHS398_CoverPageSupplement_1_3:StemCellsIndicator"/>
                              <xsl:with-param name="schemaChoice">Y: Yes</xsl:with-param>
                           </xsl:call-template>
                        </xsl:otherwise>
                     </xsl:choose>
