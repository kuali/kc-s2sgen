...
xmlns:RR_KeyPersonExpanded_1_2="http://apply.grants.gov/forms/RR_KeyPersonExpanded_1_2-V1.2" 
...
xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:header="http://devapply.row.com/system/Header-V1.0">
	...
	<xsl:template match="RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded_1_2">
		<fo:root>
			...
			<fo:page-sequence master-reference="default-page" initial-page-number="1" format="1">
				...
				<fo:flow flow-name="xsl-region-body" font-family="Helvetica,Times,Courier">
					...
					<fo:block font-size="8pt">
						...
						<fo:table width="100%" border-style="solid" border-width="1pt" border-top-width="1.5pt" border-color="black" border-bottom-width="1.0pt" table-layout="fixed">
							...
							<fo:table-body>
								...
								<!--row3, name values-->
								<xsl:for-each select="RR_KeyPersonExpanded_1_2:PDPI/RR_KeyPersonExpanded_1_2:Profile">
									<xsl:for-each select="RR_KeyPersonExpanded_1_2:Name">
										<fo:table-row>
													...
													<fo:table-body>
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en" padding-start="4pt">
																<fo:block>Position/Title:&#160;<xsl:value-of select="RR_KeyPersonExpanded_1_2:Title"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>Department:&#160;<xsl:value-of select="RR_KeyPersonExpanded_1_2:DepartmentName"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
											...
											<fo:block>
												...
												<fo:table width="100%" table-layout="fixed">
													...
													<fo:table-body>
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en" padding-start="4pt">
																<fo:block>Organization Name:&#160;<xsl:value-of select="RR_KeyPersonExpanded_1_2:OrganizationName"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>Division:&#160;<xsl:value-of select="RR_KeyPersonExpanded_1_2:DivisionName"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
									...
									<xsl:for-each select="RR_KeyPersonExpanded_1_2:Address">
										<!--row6-->
										<fo:table-row>
											<fo:table-cell line-height="10pt">
												<fo:block>
												...
												<fo:table width="100%" table-layout="fixed">
													...
													<fo:table-body>
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="RR_KeyPersonExpanded_1_2:Phone"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="RR_KeyPersonExpanded_1_2:Fax"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="RR_KeyPersonExpanded_1_2:Email"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
									...
									<fo:table-row>
										<fo:table-cell padding-start="4pt" padding-before="3pt" padding-after="3pt" line-height="8pt" border-top-style="solid" border-top-color="black" border-top-width="1.0pt">
											<fo:block>Credential, e.g., agency login:&#160;<xsl:value-of select="RR_KeyPersonExpanded_1_2:Credential"/>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
														...
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en" padding-start="4pt">
																<fo:block>* Project Role:&#160;<fo:inline font-weight="100">
																		<xsl:value-of select="RR_KeyPersonExpanded_1_2:ProjectRole"/>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>Other Project Role Category:&#160;<fo:inline font-weight="100">
																		<xsl:value-of select="RR_KeyPersonExpanded_1_2:OtherProjectRoleCategory"/>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
														...
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en" padding-start="4pt">
																<fo:block>Degree Type:&#160;<fo:inline font-weight="100">
																		<xsl:value-of select="RR_KeyPersonExpanded_1_2:DegreeType"/>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>Degree Year:&#160;<fo:inline font-weight="100">
																		<xsl:value-of select="RR_KeyPersonExpanded_1_2:DegreeYear"/>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													...
													<fo:table-body>
														...
														<fo:table-row>
															...
															<fo:table-cell text-align="center" hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:FileName"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell text-align="center">
																<fo:block>
																	<xsl:value-of select="RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:MimeType"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
														<fo:table-row>
														<fo:table-cell font-weight="bold"
															...
															<fo:table-cell text-align="center" hyphenate="true"
																...
																<fo:block>
																	<xsl:value-of
																		select="RR_KeyPersonExpanded_1_2:SupportsAttached/RR_KeyPersonExpanded_1_2:SupportAttached/att:FileName" />
																</fo:block>
															</fo:table-cell>
															<fo:table-cell text-align="center">
																<fo:block>
																	<xsl:value-of
																		select="RR_KeyPersonExpanded_1_2:SupportsAttached/RR_KeyPersonExpanded_1_2:SupportAttached/att:MimeType" />
																</fo:block>
															</fo:table-cell>
					...
					<!--========== End of PDPI========================================================================-->				
					<xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[1]/RR_KeyPersonExpanded_1_2:Profile">
						 <xsl:call-template name="KPTemplate">
                 			 <xsl:with-param name="number">1</xsl:with-param>
                  		 </xsl:call-template>  
					</xsl:for-each>
					<xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[2]/RR_KeyPersonExpanded_1_2:Profile">
                  	...
                  	<xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[3]/RR_KeyPersonExpanded_1_2:Profile">                
                 		 <xsl:call-template name="KPTemplate">
                		  	<xsl:with-param name="number">3</xsl:with-param>
                  		</xsl:call-template>            
                  	</xsl:for-each>
                   <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[4]/RR_KeyPersonExpanded_1_2:Profile">
                 		<fo:block break-after="page">
                     		<xsl:text>&#xA;</xsl:text>
                 	    </fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[5]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                 			 <xsl:with-param name="number">5</xsl:with-param>
                 		</xsl:call-template>              
                  </xsl:for-each>
                 <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[6]/RR_KeyPersonExpanded_1_2:Profile">
                 		 <fo:block break-after="page">
                   			  <xsl:text>&#xA;</xsl:text>
                 		 </fo:block>
                 		 <xsl:call-template name="KPTemplate">
               	  ...
               	  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[7]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">7</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[8]/RR_KeyPersonExpanded_1_2:Profile">
                  		<fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 	    </fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[9]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">9</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[10]/RR_KeyPersonExpanded_1_2:Profile">
                  	    <fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[11]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">11</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[12]/RR_KeyPersonExpanded_1_2:Profile">
                  	    <fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[13]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">13</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[14]/RR_KeyPersonExpanded_1_2:Profile">
                  		<fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[15]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">15</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[16]/RR_KeyPersonExpanded_1_2:Profile">
                  		<fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 	    </fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[17]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">17</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[18]/RR_KeyPersonExpanded_1_2:Profile">
                  		<fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 	    </fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[19]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">19</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[20]/RR_KeyPersonExpanded_1_2:Profile">
                  	    <fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[21]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">21</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[22]/RR_KeyPersonExpanded_1_2:Profile">
                  		<fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[23]/RR_KeyPersonExpanded_1_2:Profile">                  		
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">23</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[24]/RR_KeyPersonExpanded_1_2:Profile">
                  	    <fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[25]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">25</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[26]/RR_KeyPersonExpanded_1_2:Profile">
                  	    <fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 	    </fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[27]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">27</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[28]/RR_KeyPersonExpanded_1_2:Profile">
                  	    <fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[29]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">29</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[30]/RR_KeyPersonExpanded_1_2:Profile">
                  	    <fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[31]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">31</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[32]/RR_KeyPersonExpanded_1_2:Profile">
                  		<fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[33]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">33</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[34]/RR_KeyPersonExpanded_1_2:Profile">
                  		<fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 		</fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[35]/RR_KeyPersonExpanded_1_2:Profile">                  		
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">35</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[36]/RR_KeyPersonExpanded_1_2:Profile">
                  		<fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 	    </fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[37]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
                	 		 <xsl:with-param name="number">37</xsl:with-param>
                 	    </xsl:call-template>            
                  </xsl:for-each>
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[38]/RR_KeyPersonExpanded_1_2:Profile">
                  		<fo:block break-after="page">
                    	 	<xsl:text>&#xA;</xsl:text>
                 	    </fo:block>
                  		<xsl:call-template name="KPTemplate">
                  ...
                  <xsl:for-each select="RR_KeyPersonExpanded_1_2:KeyPerson[39]/RR_KeyPersonExpanded_1_2:Profile">
                  		<xsl:call-template name="KPTemplate">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.78787878787878px" hyphenate="true" language="en" keep-together="always" top="350.90909090909093px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName1) or //RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName1 = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName1"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.78787878787878px" hyphenate="true" language="en" keep-together="always" top="366.06060606060606px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName2) or //RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName2 = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName2"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.78787878787878px" hyphenate="true" language="en" keep-together="always" top="381.21212121212125px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName3) or //RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName3 = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName3"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.78787878787878px" hyphenate="true" language="en" keep-together="always" top="396.3636363636364px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName4) or //RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName4 = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:KeyPersonAttachmentFileName4"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
...
-->
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="441.6666666666667px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:AdditionalProfilesAttached/RR_KeyPersonExpanded_1_2:AdditionalProfileAttached/att:FileName) or //RR_KeyPersonExpanded_1_2:AdditionalProfilesAttached/RR_KeyPersonExpanded_1_2:AdditionalProfileAttached/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:AdditionalProfilesAttached/RR_KeyPersonExpanded_1_2:AdditionalProfileAttached/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="471.6666666666667px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:AdditionalProfilesAttached/RR_KeyPersonExpanded_1_2:AdditionalProfileAttached/att:MimeType) or //RR_KeyPersonExpanded_1_2:AdditionalProfilesAttached/RR_KeyPersonExpanded_1_2:AdditionalProfileAttached/att:MimeType = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:AdditionalProfilesAttached/RR_KeyPersonExpanded_1_2:AdditionalProfileAttached/att:MimeType"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
...
-->
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="521.03030303030306px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:FileName) or //RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="550.03030303030306px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:MimeType) or //RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:MimeType = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:RR_KeyPersonExpanded/RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:MimeType"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
...
-->
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="601.39393939393943px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:SupportsAttached/RR_KeyPersonExpanded_1_2:SupportAttached/att:FileName) or //RR_KeyPersonExpanded_1_2:SupportsAttached/RR_KeyPersonExpanded_1_2:SupportAttached/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
								<xsl:if test="//RR_KeyPersonExpanded_1_2:AdditionalProfilesAttached/RR_KeyPersonExpanded_1_2:AdditionalProfileAttached">
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:SupportsAttached/RR_KeyPersonExpanded_1_2:SupportAttached/att:FileName"/>
								</xsl:if>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="631.39393939393943px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//RR_KeyPersonExpanded_1_2:SupportsAttached/RR_KeyPersonExpanded_1_2:SupportAttached/att:MimeType) or //RR_KeyPersonExpanded_1_2:SupportsAttached/RR_KeyPersonExpanded_1_2:SupportAttached/att:MimeType = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
								<xsl:if test="//RR_KeyPersonExpanded_1_2:AdditionalProfilesAttached/RR_KeyPersonExpanded_1_2:AdditionalProfileAttached">
									<xsl:value-of select="//RR_KeyPersonExpanded_1_2:SupportsAttached/RR_KeyPersonExpanded_1_2:SupportAttached/att:MimeType"/>
									</xsl:if>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					...
					<fo:block-container background-color="transparent"
						border-style="none" position="absolute" left="138.66666666666669px"
						hyphenate="true" language="en" keep-together="always" top="586.6666666666667px"
						height="13.333333333333334px" width="185.63636363636365px">
							<fo:block background-color="transparent" color="#000000"
									font-size="8pt" font-style="normal" font-family="Helvetica"
									font-weight="bold">Filename</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent"
						border-style="none" position="absolute" left="138.66666666666669px"
						hyphenate="true" language="en" keep-together="always" top="616.6666666666667px"
						height="13.333333333333334px" width="185.63636363636365px">
							<fo:block background-color="transparent" color="#000000"
									font-size="8pt" font-style="normal" font-family="Helvetica"
									font-weight="bold">MimeType</fo:block>
					     	</fo:block-container>
					<fo:block-container background-color="transparent"
						border-style="none" position="absolute" left="4.242424242424242px"
						hyphenate="true" language="en" keep-together="always" top="601.39393939393943px"
						height="13.333333333333334px" width="212.72727272727275px">
							<fo:block background-color="transparent" color="#000000"
									font-size="8pt" font-style="normal" font-family="Helvetica"
									font-weight="bold">Additional Current and</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent"
						border-style="none" position="absolute" left="4.242424242424242px"
						hyphenate="true" language="en" keep-together="always" top="611.39393939393943px"
						height="13.333333333333334px" width="212.72727272727275px">
						<fo:block background-color="transparent" color="#000000"
									font-size="8pt" font-style="normal" font-family="Helvetica"
									font-weight="bold">Pending Support(s)</fo:block>
						</fo:block-container>
										...
										<fo:table-row>
											...
											<fo:table-row>
												...
												<fo:table-cell text-align="center" hyphenate="true"
													...
													<fo:block>
														<xsl:value-of
															select="RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:FileName" />
													</fo:block>
												</fo:table-cell>
												<fo:table-cell text-align="center">
													<fo:block>
														<xsl:value-of
															select="RR_KeyPersonExpanded_1_2:BioSketchsAttached/RR_KeyPersonExpanded_1_2:BioSketchAttached/att:MimeType" />
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
