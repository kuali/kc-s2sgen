...
<!--
 ...
 -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:PHS_Fellowship_Supplemental_1_1="http://apply.grants.gov/forms/PHS_Fellowship_Supplemental_1_1-V1.1" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:codes="http://apply.grants.gov/system/UniversalCodes-V2.0" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template match="PHS_Fellowship_Supplemental_1_1:PHS_Fellowship_Supplemental_1_1">
		<fo:root>
													...
													<fo:table-body start-indent="0pt">
														...
														<fo:table-row>
															<fo:table-cell padding-left="22pt" padding="2pt" display-align="center">
																<fo:block>																	
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ApplicationType">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TypeOfApplication">
																				<xsl:choose>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:IntroductionToApplication">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:SpecificAims">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchStrategy">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:InclusionEnrollmentReport">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ProgressReportPublicationList">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:HumanSubjectsInvolved">
																									<xsl:choose>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:HumanSubjectsIndefinite">
																				<xsl:choose>
																					<xsl:when test="string(.)='Y: Yes'">
																						<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																							<xsl:text>&#x2714;</xsl:text>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ClinicalTrial">
																				<xsl:choose>
																					<xsl:when test="string(.)='Y: Yes'">
																						<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																							<xsl:text>&#x2714;</xsl:text>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Phase3ClinicalTrial">
																				<xsl:choose>
																					<xsl:when test="string(.)='Y: Yes'">
																						<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																							<xsl:text>&#x2714;</xsl:text>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ProtectionOfHumanSubjects">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:InclusionOfWomenAndMinorities">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TargetedPlannedEnrollment">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:InclusionOfChildren">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:VertebrateAnimalsUsed">
																									<xsl:choose>
																										<xsl:when test="string(.)='Y: Yes'">
																											<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																												<xsl:text>&#x2714;</xsl:text>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:VertebrateAnimalsIndefinite">
																				<xsl:choose>
																					<xsl:when test="string(.)='Y: Yes'">
																						<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																							<xsl:text>&#x2714;</xsl:text>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:VertebrateAnimals">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:SelectAgentResearch">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResourceSharingPlan">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:RespectiveContributions">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:SelectionOfSponsorAndInstitution">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResearchTrainingPlan">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ResponsibleConductOfResearch">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
															...
															<fo:table-cell number-columns-spanned="2" padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:StemCells">
																				<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:isHumanStemCellsInvolved">
																					<xsl:choose>
																						<xsl:when test="string(.)='Y: Yes'">
																							<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																								<xsl:text>&#x2714;</xsl:text>
															...
															<fo:table-cell padding-left="20pt" padding-right="20pt" number-columns-spanned="2" padding="2pt" display-align="center">
																<fo:block>
																	...
																	<fo:block/>																	
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:StemCells">
																				<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:StemCellsIndicator">
																					<xsl:choose>
																						<xsl:when test="string(.)='N: No'">
																							<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																								<xsl:text>&#x2714;</xsl:text>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:StemCells">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:CellLines">
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" height="20" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AlernatePhoneNumber">
																									<xsl:variable name="value-of-template">
																										<xsl:apply-templates/>
																									</xsl:variable>
																									<xsl:choose>
																									...
																									<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																										<fo:block>
																											<fo:inline>
																												...
																												<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																													<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:GraduateDegreeSought">
																														<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:DegreeType">
																															<xsl:variable name="value-of-template">
																																<xsl:apply-templates/>
																															</xsl:variable>
																															<xsl:choose>
																									...
																									<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																										<fo:block>
																											<fo:inline>
																												...
																												<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																													<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:GraduateDegreeSought">
																														<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:OtherDegreeTypeText">
																															<xsl:variable name="value-of-template">
																																<xsl:apply-templates/>
																															</xsl:variable>
																															<xsl:choose>
																									...
																									<fo:table-cell border="solid 1pt gray" padding="2pt" height="18" display-align="center">
																										<fo:block>
																											<fo:inline>
																												...
																												<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																													<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:GraduateDegreeSought">
																														<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:DegreeDate">
																															<xsl:variable name="value-of-template">
																																<xsl:apply-templates/>
																															</xsl:variable>
																															<xsl:choose>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:FieldOfTraining">
																									<xsl:variable name="value-of-template">
																										<xsl:apply-templates/>
																									</xsl:variable>
																									<xsl:choose>
															...
															<fo:table-cell number-columns-spanned="2" padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:CurrentPriorNRSASupportIndicator">
																				<xsl:choose>
																					<xsl:when test="string(.)='Y: Yes'">
																						<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																							<xsl:text>&#x2714;</xsl:text>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:CurrentPriorNRSASupport">
																									<xsl:if test="position() = 1">
																										<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Level">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																											</xsl:variable>
																											<xsl:choose>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>																						
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:CurrentPriorNRSASupport">
																									<xsl:if test="position() =1">
																										<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Type">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																											</xsl:variable>
																											<xsl:choose>
																					...
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:CurrentPriorNRSASupport">
																									<xsl:if test="position() =1">
																										<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:StartDate">
																											<fo:inline>
																					...
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:CurrentPriorNRSASupport">
																									<xsl:if test="position() =1">
																										<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:EndDate">
																											<fo:inline>
																												<xsl:value-of select="format-number(number(substring(string(string(.)), 6, 2)), '00')"/>
																												<xsl:text>/</xsl:text>
																												<xsl:value-of select="format-number(number(substring(string(string(.)), 9, 2)), '00')"/>
																					...
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:CurrentPriorNRSASupport">
																									<xsl:if test="position() =1">
																										<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:GrantNumber">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																											</xsl:variable>
																											<xsl:choose>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ConcurrentSupport">
																				<xsl:choose>
																					<xsl:when test="string(.)='Y: Yes'">
																						<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																							<xsl:text>&#x2714;</xsl:text>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ConcurrentSupportDescription">
																				<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																					<xsl:for-each select="att:FileName">
																						<xsl:variable name="value-of-template">
																							<xsl:apply-templates/>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:FellowshipTrainingAndCareerGoals">
																				<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																					<xsl:for-each select="att:FileName">
																						<xsl:variable name="value-of-template">
																							<xsl:apply-templates/>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ActivitiesPlannedUnderThisAward">
																				<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																					<xsl:for-each select="att:FileName">
																						<xsl:variable name="value-of-template">
																							<xsl:apply-templates/>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:DissertationAndResearchExperience">
																				<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:attFile">
																					<xsl:for-each select="att:FileName">
																						<xsl:variable name="value-of-template">
																							<xsl:apply-templates/>
																				...
																				<fo:table-cell font-size="9pt" border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Citizenship">
																									<xsl:choose>
															...
															<fo:table-cell number-rows-spanned="2" padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:ChangeOfInstitution">
																				<xsl:choose>
																					<xsl:when test="string(.)='Y: Yes'">
																						<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																							<xsl:text>&#x2714;</xsl:text>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AdditionalInformation">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:FormerInstitution">
																									<xsl:variable name="value-of-template">
																										<xsl:apply-templates/>
																									</xsl:variable>
																									<xsl:choose>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		...
																		<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																			<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TuitionAndFeesRequested">
																				<xsl:choose>
																					<xsl:when test="string(.)='N: No'">
																						<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																							<xsl:text>&#x2714;</xsl:text>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TuitionRequestedYear1">
																									<fo:inline>
																										<xsl:text>$</xsl:text>
																									</fo:inline>
																									<fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TuitionRequestedYear2">
																									<fo:inline>
																										<xsl:text>$</xsl:text>
																									</fo:inline>
																									<fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TuitionRequestedYear3">
																									<fo:inline>
																										<xsl:text>$</xsl:text>
																									</fo:inline>
																									<fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TuitionRequestedYear4">
																									<fo:inline>
																										<xsl:text>$</xsl:text>
																									</fo:inline>
																									<fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TuitionRequestedYear5">
																									<fo:inline>
																										<xsl:text>$</xsl:text>
																									</fo:inline>
																									<fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TuitionRequestedYear6">
																									<fo:inline>
																										<xsl:text>$</xsl:text>
																									</fo:inline>
																									<fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:TuitionRequestedTotal">
																									<fo:inline>
																										<xsl:text>$</xsl:text>
																									</fo:inline>
																									<fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:InstitutionalBaseSalary">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Amount">
																										<fo:inline>
																											<xsl:text>$</xsl:text>
																										</fo:inline>
																										<fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:InstitutionalBaseSalary">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:AcademicPeriod">
																										<xsl:variable name="value-of-template">
																											<xsl:apply-templates/>
																										</xsl:variable>
																										<xsl:choose>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:InstitutionalBaseSalary">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:NumberOfMonths">
																										<xsl:variable name="value-of-template">
																											<xsl:apply-templates/>
																										</xsl:variable>
																										<xsl:choose>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:FederalStipendRequested">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Amount">
																										<fo:inline>
																											<xsl:text>$</xsl:text>
																										</fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:SupplementationFromOtherSources">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Amount">
																										<fo:inline>
																											<xsl:text>$</xsl:text>
																										</fo:inline>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Budget">
																								<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:SupplementationFromOtherSources">
																									<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Source">
																										<xsl:variable name="value-of-template">
																											<xsl:apply-templates/>
																										</xsl:variable>
																										<xsl:choose>
																				...
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						<fo:inline>
																							...
																							<xsl:for-each select="PHS_Fellowship_Supplemental_1_1:Appendix">
