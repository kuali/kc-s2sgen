...
<!--
 ...
 -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:PHS398_CareerDevelopmentAwardSup_1_2="http://apply.grants.gov/forms/PHS398_CareerDevelopmentAwardSup_1_2-V1.2" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:codes="http://apply.grants.gov/system/UniversalCodes-V2.0" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:template match="PHS398_CareerDevelopmentAwardSup_1_2:PHS398_CareerDevelopmentAwardSup_1_2">
		<fo:root>
									...
									<fo:table-row>
										<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
											<fo:block>
												...
												<fo:block/>
												<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:ApplicationType">
														<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:TypeOfApplication">
															<xsl:choose>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:IntroductionToApplication">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CandidateBackground">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerGoalsAndObjectives">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAndTrainingActivities">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:ResponsibleConductOfResearch">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:MentoringPlan">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:StatementsOfSupport">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:InsitutionalEnvironment">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:InstitutionalCommitment">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:SpecificAims">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:ResearchStrategy">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:InclusionEnrollmentReport">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:ProgressReportPublicationList">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" height="20" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:ProtectionOfHumanSubjects">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:InclusionOfWomenAndMinorities">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:TargetedPlannedEnrollment">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:InclusionOfChildren">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:VertebrateAnimals">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:SelectAgentResearch">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:ConsortiumContractualArrangements">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:ResourceSharingPlans">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	...
																	<xsl:if test="PHS398_CareerDevelopmentAwardSup_1_2/PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments/PHS398_CareerDevelopmentAwardSup_1_2:Appendix/att:AttachedFile">
																		<fo:table font-family="v" font-size="9pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			<fo:table-column column-width="proportional-column-width(1)"/>
																			<fo:table-body start-indent="0pt">
																				<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2">
																					<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:CareerDevelopmentAwardAttachments">
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:Appendix">
														...
														<fo:table-row font-size="8pt">
															<fo:table-cell number-columns-spanned="4" padding="2pt" display-align="before">
																<fo:block>
																	...
																	<xsl:for-each select="PHS398_CareerDevelopmentAwardSup_1_2:Citizenship">
																			<xsl:choose>
