...
import gov.grants.apply.forms.rrBudget14V14.BudgetTypeDataType;
import gov.grants.apply.forms.rrBudget14V14.BudgetYearDataType;
import gov.grants.apply.forms.rrBudget14V14.BudgetYearDataType.*;
import gov.grants.apply.forms.rrBudget14V14.BudgetYearDataType.Equipment.EquipmentList;
import gov.grants.apply.forms.rrBudget14V14.BudgetYearDataType.KeyPersons.KeyPerson;
import gov.grants.apply.forms.rrBudget14V14.BudgetYearDataType.OtherPersonnel.*;
...
import gov.grants.apply.forms.rrBudget14V14.RRBudget14Document.RRBudget14.BudgetSummary;
...
@FormGenerator("RRBudgetV1_4Generator")
public class RRBudgetV1_4Generator extends RRBudgetBaseGenerator {

    private static final Logger LOG = LoggerFactory.getLogger(RRBudgetV1_4Generator.class);

    @Value("http://apply.grants.gov/forms/RR_Budget_1_4-V1.4")
    private String namespace;

    @Value("RR_Budget_1_4")
    private String formName;

    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/stylesheet/RR_Budget-V1.4.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.rrBudget14V14")
    private String packageName;

    @Value("165")
    private int sortIndex;

    private RRBudget14Document getRRBudget14() {

        deleteAutoGenNarratives();
        RRBudget14Document rrBudgetDocument = RRBudget14Document.Factory
                .newInstance();
        RRBudget14 rrBudget = RRBudget14.Factory.newInstance();
        ...
        rrBudgetDocument.setRRBudget14(rrBudget);
        return rrBudgetDocument;
    }

    private void setBudgetYearDataType(RRBudget14 rrBudget, BudgetPeriodDto periodInfo) {
    ...
    private ParticipantTraineeSupportCosts.Other getOtherPTSupportCosts(BudgetPeriodDto periodInfo) {
        ...
        if (periodInfo != null && periodInfo.getOtherDirectCosts() != null) {
            for (OtherDirectCostInfoDto otherDirectCostInfo : periodInfo.getOtherDirectCosts()) {
                ...
                if (otherDirectCostInfo.getOtherCosts() != null
                    ...
                    other.setCost(new BigDecimal(otherDirectCostInfo
    ...
    private OtherPersonnel getOtherPersonnel(BudgetPeriodDto periodInfo) {
        ...
        Other otherPersonnelDataTypeArray[] = new Other[1];
        if (periodInfo != null) {
