...
public class SF424V2_0Generator extends SF424BaseGenerator {
    ...
    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/stylesheet/SF424-V2.0.fo.xsl")
    ...
    private SF424 getSF424() {
        ...
        if (divisionName != null) {
            sf424V2.setDivisionName(StringUtils.substring(divisionName, 0, DIVISION_NAME_MAX_LENGTH));
        }
