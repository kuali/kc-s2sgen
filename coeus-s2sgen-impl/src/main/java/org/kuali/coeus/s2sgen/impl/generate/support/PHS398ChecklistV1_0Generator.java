...
public class PHS398ChecklistV1_0Generator extends PHS398ChecklistBaseGenerator {
	private static final Logger LOG = LoggerFactory.getLogger(PHS398ChecklistV1_0Generator.class);
    ...
    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/stylesheet/PHS398_Checklist-V1.0.fo.xsl")
