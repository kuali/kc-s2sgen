...
public class RRBudget10V1_3Generator extends RRBudgetBaseGenerator {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(RRBudget10V1_3Generator.class);
    ...
    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/stylesheet/RR_Budget10-V1-3.fo.xsl")
